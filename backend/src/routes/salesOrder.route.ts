...
import { getSalesOrdersValidator, salesOrderValidator } from '../utility/validator';
...
router.get('/', authMiddleware, getSalesOrdersValidator, validate, (req: Request, res: Response) =>
